...
(function (App) {
    class ProjectItem extends App.Component {
        ...
        doubleClickHandler(_) {
            const newStatus = this.project.status === App.ProjectStatus.Active
                ? App.ProjectStatus.Finished
                : App.ProjectStatus.Active;
            App.projectState.moveProject(this.project.id, newStatus);
        }
        configure() {
...
(function (App) {
    class ProjectInput extends App.Component {
        ...
        validateUserInput(title, description, numPeople) {
            ...
            const titleValidationStatus = App.validate(titleValidatable);
            const descriptionValidationStatus = App.validate(descriptionValidatable);
            const peopleValidationStatus = App.validate(peopleValidatable);
        ...
        submitHandler(event) {
            ...
            App.projectState.addProject(title, description, numPeople);
            this.clearInputs();
        }
    }
    __decorate([
